...
function renderProjects(projects) {
  ...
  projects.forEach((project) => {
    ...
    listItem.append(project.description);
...
async function loadDataFromJson() {
  try {
    ...
    if (skillsList) {
      skillsList.innerHTML = "<li>Nie udalo sie zaladowac umiejetnosci.</li>";
    }
    if (projectsList) {
      projectsList.innerHTML = "<li>Nie udalo sie zaladowac projektow.</li>";
    }
    console.error("Blad ladowania danych JSON:", error);
  }
}
